    ...
    $('.btn-reset', '.filter-control').on('click', function () {
        var el = $(this),
            filterBlock = el.closest('.filter-block'),
            filterOption = filterBlock.find('.filter-option'),
            selectControl = filterBlock.find('.selectpicker');
    ...
    $('input', '.search-control').on('keypress', function (e) {
