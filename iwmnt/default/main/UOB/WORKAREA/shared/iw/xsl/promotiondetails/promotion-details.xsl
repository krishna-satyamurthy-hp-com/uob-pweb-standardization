<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="promotiondetails">
		...
		<xsl:variable name="actDate">
			<xsl:value-of select="Properties/Data/Result/root/promo_details/Activation_Date"/>
		</xsl:variable>
				...
				<div class="container">
					<div class="row sticky-wrapper">
						<div class="offer-content">
							<h3><xsl:value-of select="Properties/Data/Result/root/promo_details/promo_features/title_text"/></h3>
							<div class="bxslider-type-3">
								<ul class="list-unstyled">
									<xsl:for-each select="Properties/Data/Result/root/promo_details/promo_features/image_banner">
										<li>
											<img>
							...
							<div class="offer-detail">
								<!-- Offer Blocks-->
								<xsl:for-each select="Properties/Data/Result/root/promo_details/promo_features/offer_blocks/*">
					...
					<div class="row sticky-wrapper">
						<section class="other-info-block pusher-b-30 padding-0-30 no-background">
							<div id="accordion" class="panel-group margin-t-0">
								<div class="panel panel-default">
									<xsl:for-each select="Properties/Data/Result/root/promo_details/promo_features/terms_conditions">
