...
public class UOBBaseConstants {
	...
	public static final String PROMOTION_INSERT_UPDATE_QUERY = "INSERT INTO PROMOTIONLIST(PROMOID,EXPIRYDATE,ACTIVATIONDATE,PRODUCTCATEGORY,PROMOIMAGE,"
	...
	public static final String PROMOTION_DELETE_QUERY = "DELETE FROM PROMOTIONLIST WHERE PROMOID=";
}
