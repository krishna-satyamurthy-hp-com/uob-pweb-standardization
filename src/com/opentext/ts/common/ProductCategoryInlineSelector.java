...
public class ProductCategoryInlineSelector {
	private static final Log LOGGER = LogFactory.getLog(ProductCategoryInlineSelector.class);
	...
	public static void main(String path[])throws Exception
	{
		...
		List l=doc.selectNodes("//root/product_category_details/product_category_name");
