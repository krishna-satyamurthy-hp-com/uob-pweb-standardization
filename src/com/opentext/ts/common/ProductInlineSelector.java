...
public class ProductInlineSelector {
	private static final Log LOGGER = LogFactory.getLog(ProductInlineSelector.class);
	...
	public static void main(String path[])throws Exception
	{
		...
		for(Iterator ite=l.iterator();ite.hasNext();)
		{
			...
			for (Iterator ite2=l.iterator();ite2.hasNext();) {
				...
				String value = "\"" + String.format("%03d", index) + " - " + productName.getText() + "\"";
				String text = "\"" + productName.getText() + "\"";
				option.append("<option value=").append(value).append(" label=").append(text).append(" />").append("\n");
			}
        }
